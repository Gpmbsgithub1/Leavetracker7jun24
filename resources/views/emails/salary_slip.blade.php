...
">
                        ...
                        <td align="center " valign="top " style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; padding-top: 10px;padding-bottom: 25px; ">
                            <h1 style="font-family: sans-serif;font-size: 20px;color: #3d3d3d;margin-bottom: 5px;text-align: left;font-weight: 300;margin-top: 20px;padding: 0px ;font-weight: bold; ">{{$doc}}</h1>
                            ...
                            <p style="font-family: sans-serif;font-size: 16px;color: #3d3d3d;margin-bottom: 5px;text-align: left;font-weight: 300;margin-top: 20px;padding: 0px ; ">Salary Slip for month {{date('F Y')}} is uploaded to your folder.</p>
                        </td>
                    </tr>
                        ...
                        20px;font-size: 15px;color: #3d3d3d;margin-bottom: 30px;text-align: left;padding: 0px 32px;margin-top: 0; ">Skilora Technologies</p></td>
                        </tr>
                        ...
                        @if($employee->hr==1)
                            <a target="blank " href="{{route('hr.slip')}}" style=" margin-right: 15px; cursor:pointer; background: #ffffff; width: 70px; color: #3d3d3d; font-family: sans-serif; font-size: 14px; padding: 10px 15px; border-radius: 25px; font-weight: 600;
                        text-decoration: none; margin-bottom: 35px; border: 2px solid #4caf50; text-align: center; ">View</a>
                        @elseif($employee->hr==0)
                        <a target="blank " href="{{route('employee.salary_slip')}}" style=" margin-right: 15px; cursor:pointer; background: #ffffff; width: 70px; color: #3d3d3d; font-family: sans-serif; font-size: 14px; padding: 10px 15px; border-radius: 25px; font-weight: 600;
                        text-decoration: none; margin-bottom: 35px; border: 2px solid #4caf50; text-align: center; ">View</a>
                        @endif
                        </td>
