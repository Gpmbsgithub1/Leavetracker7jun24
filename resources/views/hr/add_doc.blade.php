                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-xl-6">
                                        <div class="card mt-3 mb-3">
                                            ...
                                            <div class="form-wrap">
                                                <form method="POST" id="doc_form" action="{{ route('hr.add_document_store') }}" enctype="multipart/form-data">
                                                @csrf
                                                    <div class="form-group">
                                                        <label>Document Name <span class="required-icon"></span></label>
                                                        <input class="form-control" name="doc_name" id="doc_name" >
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control w-100 custom" name="employee[]" multiple="multiple">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="field" align="left">
                                                            <span>
                                                            <input type="file" id="files" name="document" accept="application/pdf" />
                                                        </span>
                                                        </div>
                                                        @if ($errors->has('files'))
                                                         <span class="invalid-feedback" role="alert">
