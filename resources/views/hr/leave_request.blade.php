                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="side-bar d-lg-block d-none">
                                <ul>
                                    <li><a href="{{route('hr.leave_requests')}}" class="active"><i class="material-icons">holiday_village</i> Leave Request</a></li>
                                    <li><a href="{{route('hr.approved_leaves')}}" ><i class="material-icons">thumb_up</i> Approved</a></li>
                                    <li><a href="{{route('hr.rejected_leaves')}}"><i class="material-icons">thumb_down</i> Rejected</a></li>
                                </ul>
                            </div>
                        </div>
...
<div class="button-holder">
                                                            ...
                                                            <td>
                                                                <div class="dropdown dropleft">
                                                                    ...
                                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                        <a class="dropdown-item" href="{{route('hr.view_leave', $leaves->id)}}">View</a>
                                                                        <a class="dropdown-item" href="{{route('hr.leave_accept', $leaves->id)}}">Approve</a>
                                                                        <a class="dropdown-item" data-toggle="modal" data-target=".bd-example-modal-smr-{{$leaves->id}}">Reject</a>
           ...
           @foreach($fleave as $k => $leaves)
            <!-- reject modal -->
            <div class="modal fade bd-example-modal-smr-{{$leaves->id}}" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-sm">
                    ...
                    <div class="modal-content p-4">
                        ...
                        <form method="POST" action="{{route('hr.leave_reject', $leaves->id)}}" enctype="multipart/form-data">
                            @csrf
