                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="side-bar d-lg-block d-none">
                                <ul>
                                    <li><a href="{{route('hr.add_document')}}" class="active"><i class="material-icons">publish</i> Upload Document</a></li>
                                    <li><a href="{{route('hr.documents')}}"><i class="material-icons">folder</i> Uploaded Documents</a></li>
                                    <li><a href="{{route('hr.my_docs')}}"><i class="material-icons">folder</i> My Documents</a></li>
                                    <li><a href="{{route('hr.slip')}}"><i class="material-icons">folder</i>Salary Slip</a></li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-xl-6">
                                        <div class="card mt-3 mb-3">
                                            ...
                                            <div class="form-wrap">
                                                <form method="POST" id="doc_form" action="{{ route('hr.edit_document_store', $doc->id) }}" enctype="multipart/form-data">
                                                @csrf
                                                    <div class="form-group">
                                                        <label>Document Name <span class="required-icon"></span></label>
                                                        <input class="form-control" name="doc_name" id="doc_name" value="{{$doc->document_name}}">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" rows="4" name="description">{{$doc->description}}</textarea>
