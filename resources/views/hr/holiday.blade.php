...
<body class="grey-bg">
   ...
   <i class="material-icons md-light">account_circle</i>
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="side-bar d-lg-block d-none">
                                <ul>
                                    <li><a href="{{route('hr.add_holiday')}}"><i class="material-icons">add_circle</i> Add Holiday</a></li>
                                    <li><a href="{{route('hr.holiday')}}" class="active"><i class="material-icons">folder</i> Holidays</a></li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="dash-right-wrap">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-xl-12">
                                        ...
                                        <div class="table-list">
                                            ...
                                            <div class="card d-none d-lg-block">
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        @if($holiday->count())
                                                        @foreach($holiday as $k => $holidays)
                                                        <tr>

                                                            <th scope="row">{{++$i}}</th>
                                                            <td>{{$holidays->date}}</td>
                                                            <td>{{$holidays->day}}</td>
                                                            <td>{{$holidays->holiday}}</td>
                                                            ...
                                                            <td>
                                                                <div class="dropdown dropleft">
                                                                    ...
                                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                        <a class="dropdown-item" href="{{route('hr.edit_holiday', $holidays->id)}}">Edit</a>
                                                                        <a class="dropdown-item" href="#" data-toggle="modal" data-target=".bd-example-modal-sm-{{$holidays->id}}">Delete</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                        ...
                                        {!! $holiday->appends(request()->query())->links() !!}
                                    </div>
                                </div>
                            </div>
            ...
            @foreach($holiday as $k => $holidays)
            <!-- delete modal -->
            <div class="modal fade bd-example-modal-sm-{{$holidays->id}}" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-sm">
                    <div class="modal-content p-4">
                        ...
                        <div class="button-holder">
                            ...
                            <a class="btn btn-default mt-4 filz" href="{{route('hr.delete_holiday', $holidays->id)}}"><span>Delete</span></a>
                        </div>
                    </div>
                </div>
            </div>
