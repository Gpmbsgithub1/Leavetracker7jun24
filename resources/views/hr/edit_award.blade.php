                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-xl-6">
                                        <div class="card mt-3 mb-3">
                                            ...
                                            <div class="form-wrap">
                                                <form method="POST" id="doc_form" action="{{ route('hr.edit_award_store', $doc->id) }}" enctype="multipart/form-data">
                                                @csrf
                                                    <div class="form-group">
                                                        <label>Award Name <span class="required-icon"></span></label>
                                                        <input class="form-control" name="award_name" id="award_name" value="{{$doc->award_name}}">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control w-100 custom" name="employee">
                                                          ...
                                                          @foreach($emp as $emps)
                                                          @if($emps->id==$doc->employee)
                                                          <option value="{{$emps->id}}" selected>{{$emps->name}}-{{$emps->employee_id}}</option>
                                                          @else
