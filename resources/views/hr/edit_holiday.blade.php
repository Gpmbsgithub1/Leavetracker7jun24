                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-xl-6">
                                        <div class="card mt-3 mb-3">
                                            ...
                                            <div class="form-wrap">
                                                <form method="POST" id="doc_form" action="{{ route('hr.edit_holiday_store', $holiday->id) }}" enctype="multipart/form-data">
                                                @csrf
                                                    <div class="form-group">
                                                        <label>Holiday Name <span class="required-icon"></span></label>
                                                        <input class="form-control" name="holiday" id="holiday" value="{{$holiday->holiday}}">
                                                    ...
                                                    <div class="form-group">
                                                      ...
                                                      <input class="date form-control" id='datetimepicker' name="holiday_date" value="{{date('m/d/Y', strtotime($holiday->dt))}}">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" rows="4" name="description">{{$holiday->description}}</textarea>
