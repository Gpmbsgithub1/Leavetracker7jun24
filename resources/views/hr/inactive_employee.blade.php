...
<div class="main-wrap">
      ...
      <div class="col-lg-2">
        <div class="side-bar d-lg-block d-none">
          ...
          <li><a href="{{route('hr.create_employee')}}"><i class="material-icons">add_circle</i> Create Employee</a></li>
             ...
             <li><a href="{{route('hr.inactive_employees')}}" class="active"><i class="material-icons">person_off</i> Inactive Employees</a></li>
          </ul>
        </div>
      </div>
 ...
 <!-- item -->
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    ...
    <a class="dropdown-item" href="#" data-toggle="modal" data-target=".bd-example-modal-sm-{{$emps->id}}">Activate</a>
  </div>
</div></td>
    </tr>
  </tbody>
...
<div class="modal fade bd-example-modal-sm-{{$emps->id}}" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    <div class="modal-content p-4">
     ...
     <span class="content">Do you really want to activate?</span>
      <div class="button-holder">
                
             <button type="submit" class="btn btn-cancel mt-4 fils mr-3" data-dismiss="modal"><span>Cancel</span></button>
             <a href="{{route('hr.act_employee', $emps->id)}}" class="btn btn-default mt-4 filz "><span>Activate</span></a>
           </div>
    </div>
  </div>
</div>
