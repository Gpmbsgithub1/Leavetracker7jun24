                        ...
                        <div class="col-lg-2">
                            <div class="side-bar d-lg-block d-none">
                                <ul>
                                    ...
                                    <li><a href="{{route('hr.documents')}}" class="active"><i class="material-icons">folder</i> Documents</a></li>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="dropdown dropleft">
                                                                    ...
                                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                        <a class="dropdown-item" href="{{route('hr.view_document', $docs->id)}}">View</a>
                                                                        <a class="dropdown-item" href="{{route('hr.edit_document', $docs->id)}}">Edit</a>
                ...
                <div class="modal-dialog modal-sm">
                    <div class="modal-content p-4">
                        ...
                        <div class="button-holder">
                            ...
                            <a class="btn btn-default mt-4 filz" href="{{route('hr.delete_document', $docs->id)}}"><span>Delete</span></a>
                        </div>
                    </div>
                </div>
            </div>
