...
<body class="grey-bg">
   ...
   <i class="material-icons md-light">account_circle</i>
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                                            <a class="dropdown-item active" href="{{route('hr.change_password')}}">Change Password</a>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-xl-6">
            <div class="card mt-3 mb-3">
              ...
              <div class="form-wrap">
                <form method="POST" id="leave_form" action="{{ route('hr.change_password.store') }}" enctype="multipart/form-data">
                        @csrf
             ...
             <div class="button-holder">
                <a href="{{route('hr.home')}}" class="btn btn-default mt-4 filz mr-3"><span>Cancel</span></a>
