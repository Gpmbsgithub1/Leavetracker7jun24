                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="side-bar d-lg-block d-none">
                                <ul>
                                    <li><a href="{{route('employee.documents')}}"><i class="material-icons">folder</i>Documents</a></li>
                                    <li><a href="{{route('employee.salary_slip')}}" class="active"><i class="material-icons">folder</i>Salary Slip</a></li>
                                </ul>
                            </div>
                        </div>
                                    ...
                                    <div class="col-lg-12 col-xl-12">
                                        ...
                                        <div class="table-list">
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                  @if($salary->count())
                                                    @foreach($salary as $k => $salaries)
                                                    <tr>
                                                        <td>{{$salaries->employee_id}}</td>
                                                        <td>{{$salaries->date}}</td>
                                                        <td>
                                                            <a href="{{route('employee.view_salary_slip', $salaries->id)}}" class="btn btn-cancel fils"><span>View</span></a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                    @else
                                        ...
                                        {!! $salary->appends(request()->query())->links() !!}
                                    </div>
                                </div>
                            </div>
