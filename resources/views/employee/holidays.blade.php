...
<div class="main-navigation d-lg-block d-none">
  <ul class="mb-0">
    ...
    @endif
    <li><a href="{{route('employee.holidays')}}" class="active"><i class="material-icons md-light">holiday_village</i> Holiday</a></li>
  </ul>
</div>
<div class="zeynep">
                <ul>
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="side-bar d-lg-block d-none">
                                <ul>
                                    <li><a href="{{route('employee.holidays')}}" class="active"><i class="material-icons">folder</i> Holidays</a></li>
                                </ul>
                            </div>
                        </div>
