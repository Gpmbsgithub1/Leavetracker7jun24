...
<div class="main-navigation d-lg-block d-none">
  <ul class="mb-0">
    ...
    <li><a href="{{route('employee.documents')}}" class="active"><i class="material-icons md-light">folder</i> Documents</a></li>
    @if(isset($grp))
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="side-bar d-lg-block d-none">
                                <ul>
                                    <li><a href="{{route('employee.documents')}}" class="active"><i class="material-icons">folder</i>Documents</a></li>
                                    <li><a href="{{route('employee.salary_slip')}}"><i class="material-icons">folder</i>Salary Slip</a></li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="dash-right-wrap">
                                <div class="row">
                                    <div class="col-lg-4 col-xl-6 col-md-3">
                                        <h2 class="page-head">Documents</h2>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-xl-12">
                                        ...
                                        <div class="table-list">
                                            ...
                                            <div class="card d-none d-lg-block">
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        @if($doc->count())
                                                        @foreach($doc as $k => $docs)
                                                        <tr>

                                                            <th scope="row">{{++$i}}</th>
                                                            <td><a href="{{route('employee.view_document', $docs->id)}}">{{$docs->document_name}}</a></td>
                                                            @if($docs->employee=='all')
                                                            <td>All</td>
                                                            @else
                                                            <td>{{@$doc[$k]->user->employee_id}}</td>
                                                            @endif
                                                            @if($docs->employee=='all')
                                                            <td>All</td>
                                                            @else
                                                            <td>{{@$doc[$k]->user->name}}</td>
                                                            @endif
                                                            ...
                                                            <td>
                                                                <div class="dropdown dropleft">
                                                                    ...
                                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                        <a class="dropdown-item" href="{{route('employee.view_document', $docs->id)}}">View</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                        ...
                                        {!! $doc->appends(request()->query())->links() !!}
                                    </div>
                                </div>
                            </div>
