...
<div class="zeynep">
    ...
    <li><a class="top_menuactive" href="{{route('employee.home')}}"><i class="material-icons md-light">dashboard</i>Dashboard</a></li>
         ...
         <li class="has-submenu">
          <a href="{{route('employee.leaves')}}" data-submenu="stores1"><i class="material-icons md-light">holiday_village</i>Leave Request</a>
    ...
    <div class="row">
      <div class="col-lg-2">
        <div class="side-bar d-lg-block d-none">
          <ul>
            <li><a href="{{route('employee.request_leave')}}"><i class="material-icons">add_circle</i> Request Leave</a></li>
             <li><a href="{{route('employee.leaves')}}" class="active"><i class="material-icons">person</i> Applied</a></li>
                                                    ...
                                                    <tbody>
                                                      ...
                                                      @foreach($leave as $k => $leaves)
                                                        <tr>
                                                            ...
                                                            @if($leaves->leave_type=='medical_leave')
                                                            <td>Medical Leave</td>
                                                            @elseif($leaves->leave_type=='paternity_leave')
                                                            <td>Paternity Leave</td>
                                                            @elseif($leaves->leave_type=='maternity_leave')
                                                            <td>Maternity Leave</td>
                                                            @elseif($leaves->leave_type=='bereavement_leave')
                                                            <td>Bereavement Leave</td>
                                                            @elseif($leaves->leave_type=='comp_off')
                                                            <td>Comp Off Leave</td>
                                                            @elseif($leaves->leave_type=='casual_leave')
                                                            <td>Casual Leave</td>
                                                            @elseif($leaves->leave_type=='loss_of_pay')
                                                            <td>Loss of Pay</td>
                                                            @elseif($leaves->leave_type=='half_day')
                                                            ...
                                                            <td>
                                                                <div class="dropdown dropleft">
                                                                    ...
                                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                        <a class="dropdown-item" href="{{route('employee.view_leave', $leaves->id)}}">View</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
